...
<script type="text/javascript">
	...
	function showModifyForm(replyNo) {
		...
		var modifyFormHtml = "<textarea id='modify-textarea-" + replyNo + "'>" + commentContent + "</textarea>" +
					        "<button onclick='submitModify(" + replyNo + ")'>수정</button>" +
					        "<button onclick='cancelModify(" + replyNo + ")'>취소</button>";
		$("#comment-content-" + replyNo).html(modifyFormHtml);
	}
