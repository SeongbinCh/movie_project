	...
	<div class="membership_box">
		<form action="register" method="post">
			...
			<div class="form-group">
				...
				<input type="text" name="mobile" class="form-input" placeholder="전화번호">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="email" class="form-input" placeholder="이메일">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" id="addr2" name="addr2" class="form-input readonly" placeholder="주소2" readonly>
			</div>
			<div class="form-group">
				<label for="addr3" class="form-label">주소3</label>
				<input type="text" id="addr3" name="addr3" class="form-input" placeholder="주소3">
			</div>
