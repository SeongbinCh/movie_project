...
이 영화 예매 사이트는 **영화 예매, 결제, 회원 관리, 영화 정보 제공, 게시판 CRUD** 등을 구현한 웹 애플리케이션입니다.<br>
Spring Framework와 MyBatis를 기반으로 개발되었으며, KOFIC API를 통해 실시간 박스오피스를 제공합니다.
...
- 영화, 날짜, 시간 선택<br>
  ...
  - 영화, 날짜, 시간을 선택한 후 **[좌석 선택]** 버튼을 클릭합니다.<p>
- 좌석 선택 (청소년/성인 인원 구분)<br>
  ...
  - 인원(청소년/성인)을 선택한 후 원하는 좌석을 선택하고 **[결제]** 버튼을 누릅니다.<p>
- 결제 전 정보 확인
- KakaoPay / TossPayments 연동 결제<br>
  <img src="https://github.com/user-attachments/assets/7c0e1830-9773-4f05-b53c-d530c9042201" width="600" height="450">
  - 결제 전 예매 정보를 확인한 뒤, **카카오페이 또는 토스페이**를 선택하여 팝업 창에서 결제를 진행합니다.<p>
...
### 5. **기타 예외 처리**
- 로그인하지 않은 사용자가 예매, 댓글, 마이페이지 접근 시 alert 처리, 로그인하지 않은 사용자면 게시글 리스트 페이지에서 글쓰기가 표시 안됌
